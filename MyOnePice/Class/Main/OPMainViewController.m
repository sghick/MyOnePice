...
- (WPSwipeView *)swipeView {
    if (_swipeView == nil) {
        ...
        [swipeView setSwipeOutAnimationBlock:^(NSTimeInterval duration, NSTimeInterval delay, AnimationsBlock animations, CompletionBlock completion) {
        ...
        [swipeView setSwipeInAnimationBlock:^(NSTimeInterval duration, NSTimeInterval delay, AnimationsBlock animations, CompletionBlock completion) {
            [UIView animateWithDuration:duration
                                  delay:delay
        ...
        [swipeView setSwipeCancelAnimationBlock:^(NSTimeInterval duration, NSTimeInterval delay, AnimationsBlock animations, CompletionBlock completion) {
            [UIView animateWithDuration:duration
                                  delay:delay
                 usingSpringWithDamping:0.9
                  initialSpringVelocity:0
