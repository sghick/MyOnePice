...
@property (strong, nonatomic) NSString *key;                            /*< 和page作为唯一标识,默认SM标识+URL的MD5码 */
...
@property (strong, nonatomic) NSArray *responseArray;               /*< 用于保存请求到的数据 */
...
@property (strong, nonatomic) NSData *responseCacheData;                 /*< 用于保存请求到的数据 */
@property (strong, nonatomic) NSDictionary *responseCacheDictionary;     /*< 用于保存请求到的数据 */
@property (strong, nonatomic) NSArray *responseCacheArray;               /*< 用于保存请求到的数据 */
...
+ (NSString *)keyOfRequestUrl:(NSString *)url; /*< 获取url的唯一标识 */
